...
export default function RRONHero({
  ...
  carBackgroundSrc = "/hero.png?v=15",
}: RRONHeroProps) {
  return (
    <section className="relative overflow-x-clip overflow-y-visible bg-[#06080f]">
      {/* Mobil: volle Fläche | md+: unter Navbar + etwas größer skaliert */}
      <div className="absolute inset-0">
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 top-0 z-0 overflow-hidden md:top-[86px]"
          aria-hidden="true"
        >
          <img
            ...
            alt=""
            aria-hidden="true"
            className="h-full w-full origin-center object-contain object-[center_42%] max-md:!scale-[1.22] md:scale-[0.91]"
            loading="eager"
            decoding="async"
          />
        </div>
